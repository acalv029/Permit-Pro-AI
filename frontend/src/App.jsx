      ...
      <div className="relative z-10 pt-24 px-6 pb-12 flex-grow">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            {/* CUSTOM PERMIT DISCLAIMER - PROMINENT */}
            <div className="bg-amber-500/10 border-2 border-amber-500/40 rounded-2xl p-8">
              <h2 className="text-2xl font-black text-amber-400 mb-4 flex items-center gap-3">⚠️ SERVICE DISCLAIMER — PLEASE READ</h2>
              ...
              <ul className="space-y-3 text-gray-300">
                ...
                <li className="flex gap-3"><span className="text-amber-400 font-bold shrink-0">7.</span>We are <strong className="text-white">NOT liable</strong> for permit denials, project delays, fines, penalties, or any direct, indirect, incidental, or consequential damages resulting from reliance on our analysis.</li>
            ...
            <div className="bg-gray-900/80 rounded-xl p-6 border border-gray-800">
              <h2 className="text-xl font-bold text-white mb-4">Interpretation and Definitions</h2>
              <h3 className="text-lg font-semibold text-cyan-400 mb-3">Interpretation</h3>
              <p className="text-gray-400 mb-4">The words whose initial letters are capitalized have meanings defined under the following conditions. The following definitions shall have the same meaning regardless of whether they appear in singular or in plural.</p>
              <h3 className="text-lg font-semibold text-cyan-400 mb-3">Definitions</h3>
              <p className="text-gray-400 mb-3">For the purposes of these Terms and Conditions:</p>
              <ul className="space-y-2 text-gray-400">
                ...
                <li><strong className="text-gray-300">Terms and Conditions</strong> means these Terms and Conditions which govern Your access to and use of the Service.</li>
            ...
            <div className="bg-gray-900/80 rounded-xl p-6 border border-gray-800">
              ...
              <p className="text-gray-400 mb-3">These are the Terms and Conditions governing the use of this Service and the agreement between You and the Company. These Terms and Conditions set out the rights and obligations of all users regarding the use of the Service.</p>
              <p className="text-gray-400 mb-3">Your access to and use of the Service is conditioned on Your acceptance of and compliance with these Terms and Conditions. These Terms and Conditions apply to all visitors, users and others who access or use the Service.</p>
              <p className="text-gray-400 mb-3">By accessing or using the Service You agree to be bound by these Terms and Conditions. If You disagree with any part of these Terms and Conditions then You may not access the Service.</p>
              <p className="text-gray-400 mb-3">You represent that you are over the age of 18. The Company does not permit those under 18 to use the Service.</p>
              <p className="text-gray-400">Your access to and use of the Service is also subject to Our Privacy Policy. Please read Our Privacy Policy carefully before using Our Service.</p>
            </div>

            <div className="bg-gray-900/80 rounded-xl p-6 border border-gray-800">
              <h2 className="text-xl font-bold text-white mb-4">Subscriptions</h2>
              <h3 className="text-lg font-semibold text-cyan-400 mb-3">Subscription Period</h3>
              <p className="text-gray-400 mb-4">The Service or some parts of the Service are available only with a paid Subscription. You will be billed in advance on a recurring and periodic basis (such as monthly), depending on the type of Subscription plan you select. At the end of each period, Your Subscription will automatically renew under the exact same conditions unless You cancel it or the Company cancels it.</p>
              <h3 className="text-lg font-semibold text-cyan-400 mb-3">Subscription Cancellations</h3>
              ...
              <h3 className="text-lg font-semibold text-cyan-400 mb-3">Billing</h3>
              <p className="text-gray-400 mb-4">You shall provide the Company with accurate and complete billing information. Should automatic billing fail to occur for any reason, the Company will issue an electronic invoice indicating that you must proceed manually with the full payment.</p>
              <h3 className="text-lg font-semibold text-cyan-400 mb-3">Fee Changes</h3>
              <p className="text-gray-400 mb-4">The Company, in its sole discretion and at any time, may modify the Subscription fees. Any Subscription fee change will become effective at the end of the then-current Subscription period. The Company will provide You with reasonable prior notice of any change in Subscription fees.</p>
              <h3 className="text-lg font-semibold text-cyan-400 mb-3">Refunds</h3>
              <p className="text-gray-400">Except when required by law, paid Subscription fees are non-refundable. Certain refund requests for Subscriptions may be considered by the Company on a case-by-case basis and granted at the sole discretion of the Company.</p>
            </div>

            <div className="bg-gray-900/80 rounded-xl p-6 border border-gray-800">
              <h2 className="text-xl font-bold text-white mb-4">In-app Purchases</h2>
              <p className="text-gray-400 mb-3">The Application may include In-app Purchases that allow you to buy products, services or Subscriptions.</p>
              <p className="text-gray-400 mb-3">In-app Purchases can only be consumed within the Application. If you make an In-app Purchase, that In-app Purchase cannot be cancelled after you have initiated its download. In-app Purchases cannot be redeemed for cash or other consideration or otherwise transferred.</p>
              <p className="text-gray-400">If any In-app Purchase is not successfully delivered or does not work, we will investigate the reason for the fault and act reasonably in deciding whether to provide You with a replacement or issue a refund. In no event will We charge You to replace or repair the In-app Purchase.</p>
            </div>

            <div className="bg-gray-900/80 rounded-xl p-6 border border-gray-800">
              <h2 className="text-xl font-bold text-white mb-4">User Accounts</h2>
              <p className="text-gray-400 mb-3">When You create an Account with Us, You must provide information that is accurate, complete, and current at all times. Failure to do so constitutes a breach of the Terms, which may result in immediate termination of Your Account.</p>
              <p className="text-gray-400 mb-3">You are responsible for safeguarding the password that You use to access the Service and for any activities or actions under Your password.</p>
              <p className="text-gray-400">You agree not to disclose Your password to any third party. You must notify Us immediately upon becoming aware of any breach of security or unauthorized use of Your Account.</p>
            </div>

            <div className="bg-gray-900/80 rounded-xl p-6 border border-gray-800">
              <h2 className="text-xl font-bold text-white mb-4">Content</h2>
              <h3 className="text-lg font-semibold text-cyan-400 mb-3">Your Right to Post Content</h3>
              <p className="text-gray-400 mb-4">Our Service allows You to upload Content. You are responsible for the Content that You post to the Service, including its legality, reliability, and appropriateness. By posting Content, You grant Us the right and license to use, modify, and process such Content on and through the Service for the purpose of providing our analysis services. You retain any and all of Your rights to any Content You submit.</p>
              <h3 className="text-lg font-semibold text-cyan-400 mb-3">Content Restrictions</h3>
              <p className="text-gray-400 mb-3">You may not transmit any Content that is unlawful, offensive, threatening, libelous, defamatory, obscene or otherwise objectionable. This includes but is not limited to:</p>
              <ul className="list-disc list-inside text-gray-400 space-y-1 mb-4">
                ...
                <li>Content infringing on proprietary rights of any party</li>
                <li>Impersonating any person or entity</li>
                <li>False information</li>
              </ul>
              <h3 className="text-lg font-semibold text-cyan-400 mb-3">Content Backups</h3>
              <p className="text-gray-400">Although regular backups of Content are performed, the Company does not guarantee there will be no loss or corruption of data. You agree to maintain a complete and accurate copy of any Content in a location independent of the Service.</p>
            </div>

            <div className="bg-gray-900/80 rounded-xl p-6 border border-gray-800">
              <h2 className="text-xl font-bold text-white mb-4">Copyright Policy</h2>
              <p className="text-gray-400 mb-3">We respect the intellectual property rights of others. If You are a copyright owner and You believe that copyrighted work has been copied in a way that constitutes copyright infringement, You must submit Your notice in writing to our copyright agent via email at <a href="mailto:support@flopermit.com" className="text-cyan-400 hover:underline">support@flopermit.com</a>.</p>
              <p className="text-gray-400 mb-3">You may submit a notification pursuant to the Digital Millennium Copyright Act (DMCA) by providing our Copyright Agent with the following information in writing:</p>
              <ul className="list-disc list-inside text-gray-400 space-y-1">
                <li>An electronic or physical signature of the authorized person</li>
                <li>A description of the copyrighted work that You claim has been infringed</li>
                <li>Identification of the URL or location where the infringing material is located</li>
            ...
            <div className="bg-gray-900/80 rounded-xl p-6 border border-gray-800">
              ...
              <p className="text-gray-400">The Service and its original content (excluding Content provided by You or other users), features and functionality are and will remain the exclusive property of the Company and its licensors. The Service is protected by copyright, trademark, and other laws. Our trademarks and trade dress may not be used in connection with any product or service without the prior written consent of the Company.</p>
            </div>

            <div className="bg-gray-900/80 rounded-xl p-6 border border-gray-800">
              <h2 className="text-xl font-bold text-white mb-4">Your Feedback to Us</h2>
              <p className="text-gray-400">You assign all rights, title and interest in any Feedback You provide the Company. If for any reason such assignment is ineffective, You agree to grant the Company a non-exclusive, perpetual, irrevocable, royalty free, worldwide right and license to use, reproduce, disclose, sub-license, distribute, modify and exploit such Feedback without restriction.</p>
            </div>

            <div className="bg-gray-900/80 rounded-xl p-6 border border-gray-800">
              <h2 className="text-xl font-bold text-white mb-4">Links to Other Websites</h2>
              <p className="text-gray-400">Our Service may contain links to third-party websites or services that are not owned or controlled by the Company. The Company has no control over, and assumes no responsibility for, the content, privacy policies, or practices of any third-party websites or services. We strongly advise You to read the terms and conditions and privacy policies of any third-party websites or services that You visit.</p>
            </div>

            <div className="bg-gray-900/80 rounded-xl p-6 border border-gray-800">
              <h2 className="text-xl font-bold text-white mb-4">Termination</h2>
              <p className="text-gray-400 mb-3">We may terminate or suspend Your Account immediately, without prior notice or liability, for any reason whatsoever, including without limitation if You breach these Terms and Conditions.</p>
              <p className="text-gray-400">Upon termination, Your right to use the Service will cease immediately. If You wish to terminate Your Account, You may simply discontinue using the Service.</p>
            </div>

            <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-6">
              <h2 className="text-xl font-bold text-red-400 mb-4">Limitation of Liability</h2>
              <p className="text-gray-300 mb-3">Notwithstanding any damages that You might incur, the entire liability of the Company and any of its suppliers under any provision of these Terms and Your exclusive remedy for all of the foregoing shall be limited to the amount actually paid by You through the Service or 100 USD if You haven't purchased anything through the Service.</p>
              <p className="text-gray-300 mb-3">To the maximum extent permitted by applicable law, in no event shall the Company or its suppliers be liable for any special, incidental, indirect, or consequential damages whatsoever (including, but not limited to, damages for loss of profits, loss of data or other information, for business interruption, for personal injury, loss of privacy arising out of or in any way related to the use of or inability to use the Service, third-party software and/or third-party hardware used with the Service, or otherwise in connection with any provision of these Terms), even if the Company or any supplier has been advised of the possibility of such damages.</p>
              <p className="text-gray-300">Some states do not allow the exclusion of implied warranties or limitation of liability for incidental or consequential damages. In these states, each party's liability will be limited to the greatest extent permitted by law.</p>
            </div>

            <div className="bg-red-500/10 border border-red-500/30 rounded-xl p-6">
              <h2 className="text-xl font-bold text-red-400 mb-4">"AS IS" and "AS AVAILABLE" Disclaimer</h2>
              <p className="text-gray-300 mb-3">The Service is provided to You "AS IS" and "AS AVAILABLE" and with all faults and defects without warranty of any kind. To the maximum extent permitted under applicable law, the Company expressly disclaims all warranties, whether express, implied, statutory or otherwise, with respect to the Service, including all implied warranties of merchantability, fitness for a particular purpose, title and non-infringement.</p>
              <p className="text-gray-300">Without limiting the foregoing, the Company provides no warranty or undertaking, and makes no representation of any kind that the Service will meet Your requirements, achieve any intended results, be compatible or work with any other software, applications, systems or services, operate without interruption, meet any performance or reliability standards or be error free or that any errors or defects can or will be corrected.</p>
            </div>

            <div className="bg-gray-900/80 rounded-xl p-6 border border-gray-800">
              <h2 className="text-xl font-bold text-white mb-4">Governing Law</h2>
              <p className="text-gray-400">The laws of the Country, excluding its conflicts of law rules, shall govern these Terms and Your use of the Service. Your use of the Application may also be subject to other local, state, national, or international laws.</p>
            </div>

            <div className="bg-gray-900/80 rounded-xl p-6 border border-gray-800">
              <h2 className="text-xl font-bold text-white mb-4">Disputes Resolution</h2>
              <p className="text-gray-400">If You have any concern or dispute about the Service, You agree to first try to resolve the dispute informally by contacting the Company.</p>
            </div>

            <div className="bg-gray-900/80 rounded-xl p-6 border border-gray-800">
              <h2 className="text-xl font-bold text-white mb-4">United States Legal Compliance</h2>
              <p className="text-gray-400">You represent and warrant that (i) You are not located in a country that is subject to the United States government embargo, or that has been designated by the United States government as a "terrorist supporting" country, and (ii) You are not listed on any United States government list of prohibited or restricted parties.</p>
            </div>

            <div className="bg-gray-900/80 rounded-xl p-6 border border-gray-800">
              <h2 className="text-xl font-bold text-white mb-4">Severability and Waiver</h2>
              <p className="text-gray-400 mb-3"><strong className="text-gray-300">Severability:</strong> If any provision of these Terms is held to be unenforceable or invalid, such provision will be changed and interpreted to accomplish the objectives of such provision to the greatest extent possible under applicable law and the remaining provisions will continue in full force and effect.</p>
              <p className="text-gray-400"><strong className="text-gray-300">Waiver:</strong> Except as provided herein, the failure to exercise a right or to require performance of an obligation under these Terms shall not affect a party's ability to exercise such right or require such performance at any time thereafter nor shall the waiver of a breach constitute a waiver of any subsequent breach.</p>
            </div>

            <div className="bg-gray-900/80 rounded-xl p-6 border border-gray-800">
              <h2 className="text-xl font-bold text-white mb-4">Changes to These Terms and Conditions</h2>
              <p className="text-gray-400">We reserve the right, at Our sole discretion, to modify or replace these Terms at any time. If a revision is material We will make reasonable efforts to provide at least 30 days' notice prior to any new terms taking effect. By continuing to access or use Our Service after those revisions become effective, You agree to be bound by the revised terms.</p>
            </div>

            <div className="bg-gray-900/80 rounded-xl p-6 border border-gray-800">
              <h2 className="text-xl font-bold text-white mb-4">Contact Us</h2>
              <p className="text-gray-400 mb-2">If you have any questions about these Terms and Conditions, You can contact us:</p>
              <ul className="text-gray-400 space-y-1">
                ...
                <li>By visiting: <button onClick={() => setPage('contact')} className="text-cyan-400 hover:underline">our Contact page</button></li>
              </ul>
            </div>
      ...
      <div className="relative z-10 pt-24 px-6 pb-12 flex-grow">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-400">This Privacy Policy describes how Flo Permit ("We", "Us", "Our") collects, uses, and protects your information when you use our Service.</p>

            <div className="bg-gray-900/80 rounded-xl p-6 border border-gray-800">
              <h2 className="text-xl font-bold text-white mb-4">1. Information We Collect</h2>
              <p className="text-gray-400 mb-3">We collect information you provide directly:</p>
              <ul className="list-disc list-inside text-gray-400 space-y-2">
                <li><strong className="text-gray-300">Account Information:</strong> Email address, name, company name (optional)</li>
                <li><strong className="text-gray-300">Payment Information:</strong> Processed securely by Stripe. We do not store credit card numbers.</li>
                <li><strong className="text-gray-300">Uploaded Documents:</strong> Permit documents you submit for analysis</li>
                <li><strong className="text-gray-300">Usage Data:</strong> How you interact with our Service, including pages visited, features used, and analysis history</li>
                <li><strong className="text-gray-300">Device Information:</strong> Browser type, IP address, device type</li>
              </ul>
            </div>
            ...
            <div className="bg-gray-900/80 rounded-xl p-6 border border-gray-800">
              ...
              <ul className="list-disc list-inside text-gray-400 space-y-2">
                <li>Provide, maintain, and improve our permit analysis Service</li>
                ...
                <li>Analyze usage patterns to improve our AI analysis accuracy</li>
                <li>Detect, prevent, and address technical issues or abuse</li>
              </ul>
            </div>

            <div className="bg-emerald-500/10 border border-emerald-500/30 rounded-xl p-6">
              <h2 className="text-xl font-bold text-emerald-400 mb-4 flex items-center gap-3">🔒 3. Document Security</h2>
              <ul className="list-disc list-inside text-gray-300 space-y-2">
                <li>Your uploaded documents are processed securely using encrypted connections (HTTPS/TLS)</li>
                <li>Documents are used <strong>only</strong> for the purpose of providing analysis</li>
                <li>We do <strong>not</strong> share your documents with third parties other than our AI processing provider (Anthropic) for the sole purpose of analysis</li>
                <li>Documents are <strong>not</strong> used to train AI models</li>
                <li>You can request deletion of your documents and data at any time</li>
              </ul>
            </div>

            <div className="bg-gray-900/80 rounded-xl p-6 border border-gray-800">
              <h2 className="text-xl font-bold text-white mb-4">4. Information Sharing</h2>
              <p className="text-gray-400 mb-3">We do <strong className="text-white">NOT</strong> sell your personal information. We may share limited data with:</p>
              <ul className="list-disc list-inside text-gray-400 space-y-2">
                <li><strong className="text-gray-300">Stripe</strong> — Payment processing (card info goes directly to Stripe, not to us)</li>
                <li><strong className="text-gray-300">Anthropic</strong> — AI analysis of your documents</li>
                <li><strong className="text-gray-300">Resend</strong> — Sending transactional emails (welcome emails, password resets)</li>
                <li><strong className="text-gray-300">Sentry</strong> — Error monitoring and performance tracking</li>
                <li><strong className="text-gray-300">Legal Requirements</strong> — If required by law, court order, or to protect our rights</li>
              </ul>
            </div>
            ...
            <div className="bg-gray-900/80 rounded-xl p-6 border border-gray-800">
              ...
              <ul className="list-disc list-inside text-gray-400 space-y-2">
                <li>Industry-standard encryption for all data in transit (HTTPS/TLS)</li>
            ...
            <div className="bg-gray-900/80 rounded-xl p-6 border border-gray-800">
              ...
              <p className="text-gray-400">We use essential cookies and local storage to keep you logged in and remember your preferences. We use Sentry for error tracking and performance monitoring. We do not use advertising cookies or trackers.</p>
            </div>
            ...
            <div className="bg-gray-900/80 rounded-xl p-6 border border-gray-800">
              ...
              <ul className="list-disc list-inside text-gray-400 space-y-2">
                <li><strong className="text-gray-300">Access</strong> your personal data</li>
                <li><strong className="text-gray-300">Correct</strong> inaccurate information</li>
                <li><strong className="text-gray-300">Delete</strong> your account and all associated data</li>
                <li><strong className="text-gray-300">Export</strong> your analysis history</li>
                <li><strong className="text-gray-300">Opt out</strong> of non-essential communications</li>
              </ul>
            ...
            <div className="bg-gray-900/80 rounded-xl p-6 border border-gray-800">
              ...
              <p className="text-gray-400">We retain your account information as long as your account is active. Analysis history is retained to provide you access to past results. If you delete your account, all associated personal data will be removed within 30 days. Some anonymized, aggregated data may be retained for analytics purposes.</p>
            </div>

            <div className="bg-gray-900/80 rounded-xl p-6 border border-gray-800">
              <h2 className="text-xl font-bold text-white mb-4">9. Children's Privacy</h2>
              <p className="text-gray-400">Our Service is not intended for users under 18 years of age. We do not knowingly collect personal information from children. If we become aware that we have collected data from a child under 18, we will take steps to delete that information.</p>
            </div>

            <div className="bg-gray-900/80 rounded-xl p-6 border border-gray-800">
              <h2 className="text-xl font-bold text-white mb-4">10. Changes to This Privacy Policy</h2>
              <p className="text-gray-400">We may update this Privacy Policy from time to time. We will notify you of significant changes via email or through the Service. Your continued use of the Service after changes constitutes acceptance of the updated policy.</p>
            </div>
